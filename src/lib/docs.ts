...
export const docs: DocMeta[] = [
  ...
  {
    slug: "milestone-3-2nd-semester",
    title: "M3: Legal, Business, and Risk Review",
    summary: "Legal requirements, licensing, terms, regulation, risk analysis, and business direction.",
    updated: "2026-05-04",
    file: "milestone-3-2nd-semester.md",
    phase: "2nd Semester",
    order: 16,
    isMilestone: true,
    milestoneLabel: "M3",
  ...
  {
    slug: "milestone-4-2nd-semester",
    title: "M4: Security, Performance, and Project Management",
    summary: "Performance testing, scalability limits, security review, algorithms, edge cases, and delivery process.",
    updated: "2026-05-19",
    file: "milestone-4-2nd-semester.md",
    phase: "2nd Semester",
    order: 17,
    isMilestone: true,
    milestoneLabel: "M4",
  ...
  {
    slug: "milestone-5-2nd-semester",
    title: "M5: Final Demo Materials",
    summary: "Poster, launch video, and final demo plan for presenting SecureLearning.",
    updated: "2026-06-02",
    file: "milestone-5-2nd-semester.md",
    phase: "2nd Semester",
    order: 18,
    isMilestone: true,
    milestoneLabel: "M5",
